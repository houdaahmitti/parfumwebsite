...
.navbar .dropdown-toggle {
  color: #12233c !important;   /* couleur souhaitée */
  font-weight: 500;            /* optionnel, texte un peu bold */
  position: relative;
}
...
.icon-btn:hover {
  background: rgba(151,68,109,0.12);
  color: #97446d;
...
.search-input:focus {
  outline: none;
  border-color: #97446d;
  box-shadow: 0 0 6px rgba(151,68,109,0.3);
}
